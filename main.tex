...
Perhaps even more tellingly, contemporary architects came out to defend Guyer's work, stating that
...
What does this entirely predictable knee-jerk reaction say about the relationship between art, architecture and democracy? We have seen that what is arguably the most inescapable form of public art is being rejected by the majority of the population, and the professional artists reject any notion of accountability to "ignorant laypeople". This questions is multi-faceted, branching into economics, psychology and philosophy. The past years have seen the emergence of two different approaches. 

One the one hand, the formation of bottom-up citizen initiatives. This has been termed a "revolt against 'ugly' modern architecture"  \cite{gersten_scandinavian_2023} and was very successful in many countries MENTION MICHAEL DIAMANT. \cref{fig:vienna} and \cref{fig:budaptest} show two diametrically opposed approaches to the replacement of existing building stock in cities that share a similar socio-economic and architectural legacy. 

On the other hand, a movement originating from contemporary academic research on “value-sensitive design”
