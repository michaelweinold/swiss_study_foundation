...
The concept of beauty in architecture has sparked ceaseless and unresolved discussions and controversies. 
'beauty is subjective'
'war on beauty' (de Botton)
\cite{loos_ornament_1908}

This stands in stark contrast to the reality, where people have had an intuition of the beautiful since time immemorial (citation needed). Neuroscience and psychology have only recently been able to contribute significantly to the debate. Resaerch interest in the area has increased significantly over the past 20 years.\footnote{The Elsevier Scopus scientific publication database clearly shows this trend. A search query for publications exploring the relationship between beauty in architecture in the context of psychology and neurology shows an exponential increase: \texttt{TITLE-ABS-KEY((architecture AND beauty) AND (psycho* OR neuro*))}} 



Results have been conclusive:
...
\textit{"Built environments that integrate representations of the natural world into façades and interiors benefit occupant psycho-physiological wellbeing and behavior. However, the biophilic quality of buildings does not depend exclusively on “green”, but also upon “organized complexity” in their structure."} \newline - Berto et al. (2022) \cite{berto_biophilic_2022}


Despite the best efforts of the authors, no instance was found
